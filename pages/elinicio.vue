<template>
  <v-layout row wrap text-xs-center>
    ...
    <v-flex xs4>
      <v-btn dark color="retinaazul" @click="modallogin=true">Acceder a estadísticas Retina Latina</v-btn>
    </v-flex>
    <v-flex xs4>
      <v-btn dark color="retinaazul" @click="modalacceso=true">Solicitar acceso</v-btn>
    </v-flex>
    <v-flex xs4>
      <v-btn dark color="retinaazul" @click="modalrestablecer=true">Restablecer contraseña</v-btn>
    </v-flex>
    <!-- MODAL LOGIN -->
